...
BOOST_AUTO_TEST_CASE(second)
{
    ...
    educational_institution t1 {.is_free = false,.name = "123" ,.count = 200,.director = {.full_name = "Billy",.mail = "dontcheckit.com"},.shift = educational_institution::SHIFT_DATE::FIRST},t2;
    test << t1;
    test >> t2;
    BOOST_ASSERT(!(t1 == t2));
